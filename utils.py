...
def process_responses_49(hiv_exposure,active_cancer,ulcers_sores, ear_infection,
                        ...
                        asthma_attacks, antipsychotic_medication,lung_cancer, death_feeling,
                        ...
                        symptoms_progression,symptoms_increased, immunosuppressed, pneumothorax_family, pericarditis,decrease_appetite,blood_vessels, lesions_redness,voice_tone,difficulty_speaking,ebola_exposure,
    ...
    df = {
        ...
        'Are the symptoms or pain increased with coughing, with an effort like lifting a weight or from forcing a bowel movement?':int(boolean_format(symptoms_increased)),
        ...
        'Are you immunosuppressed?':int(boolean_format(immunosuppressed)),
        'Have any of your family members ever had a pneumothorax?':int(boolean_format(pneumothorax_family)),
